...
class RenStudy(ClassifierMixin):
...
def study_ren(features, target, preprocessing=StandardScaler(), grid=True, random_seed=42, output_file='idowu.json'):
    results= {}
    base_classifier= AdaBoostClassifier(random_state=random_seed)
    grid_search_params= {'n_estimators': [10, 50, 100, 500], 'learning_rate': [0.1, 0.5, 1.0]}
