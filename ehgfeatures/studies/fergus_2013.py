...
class Fergus2013Study(ClassifierMixin):
...
def study_fergus_2013(features, target, preprocessing=StandardScaler(), grid=True, random_seed=42, output_file='fergus_2013_results.json'):
    results= {}
